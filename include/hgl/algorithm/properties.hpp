...
[[nodiscard]] size_type max_degree(traits::c_hypergraph auto&& hypergraph) noexcept {
...
[[nodiscard]] size_type min_degree(traits::c_hypergraph auto&& hypergraph) noexcept {
    const auto degrees = hypergraph.degree_map();
...
[[nodiscard]] size_type max_out_degree(traits::c_bf_directed_hypergraph auto&& hypergraph
) noexcept {
...
[[nodiscard]] size_type min_out_degree(traits::c_bf_directed_hypergraph auto&& hypergraph
) noexcept {
    const auto degrees = hypergraph.out_degree_map();
    return degrees.empty() ? 0uz : *std::ranges::min_element(degrees);
}
...
[[nodiscard]] size_type max_in_degree(traits::c_bf_directed_hypergraph auto&& hypergraph) noexcept {
...
[[nodiscard]] size_type min_in_degree(traits::c_bf_directed_hypergraph auto&& hypergraph) noexcept {
    const auto degrees = hypergraph.in_degree_map();
    return degrees.empty() ? 0uz : *std::ranges::min_element(degrees);
}
...
[[nodiscard]] size_type rank(traits::c_hypergraph auto&& hypergraph) noexcept {
...
[[nodiscard]] size_type corank(traits::c_hypergraph auto&& hypergraph) noexcept {
    const auto sizes = hypergraph.hyperedge_size_map();
...
[[nodiscard]] size_type max_tail_size(traits::c_bf_directed_hypergraph auto&& hypergraph) noexcept {
...
[[nodiscard]] size_type min_tail_size(traits::c_bf_directed_hypergraph auto&& hypergraph) noexcept {
    const auto sizes = hypergraph.tail_size_map();
    return sizes.empty() ? 0uz : *std::ranges::min_element(sizes);
}
...
[[nodiscard]] size_type max_head_size(traits::c_bf_directed_hypergraph auto&& hypergraph) noexcept {
...
[[nodiscard]] size_type min_head_size(traits::c_bf_directed_hypergraph auto&& hypergraph) noexcept {
    const auto sizes = hypergraph.head_size_map();
    return sizes.empty() ? 0uz : *std::ranges::min_element(sizes);
}
...
[[nodiscard]] bool is_regular(traits::c_hypergraph auto&& hypergraph, const size_type k) noexcept {
...
[[nodiscard]] bool is_regular(traits::c_hypergraph auto&& hypergraph) noexcept {
...
[[nodiscard]] bool is_out_regular(
    traits::c_bf_directed_hypergraph auto&& hypergraph, const size_type k
) noexcept {
...
[[nodiscard]] bool is_out_regular(traits::c_bf_directed_hypergraph auto&& hypergraph) noexcept {
...
[[nodiscard]] bool is_in_regular(traits::c_bf_directed_hypergraph auto&& hypergraph) noexcept {
...
[[nodiscard]] bool is_uniform(traits::c_hypergraph auto&& hypergraph, const size_type k) noexcept {
...
[[nodiscard]] bool is_uniform(traits::c_hypergraph auto&& hypergraph) noexcept {
...
[[nodiscard]] bool is_tail_uniform(traits::c_bf_directed_hypergraph auto&& hypergraph) noexcept {
...
[[nodiscard]] bool is_head_uniform(traits::c_bf_directed_hypergraph auto&& hypergraph) noexcept {
