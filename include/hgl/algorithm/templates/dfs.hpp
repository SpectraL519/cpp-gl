...
/// | InitQueueRangeType | A forward range of `search_node<val_t<H>>` used to prime the DFS stack. | Must be a *forward range* of @ref hgl::algorithm::search_node "search nodes". |
...
bool dfs(
    ...
    std::stack<search_node<val_t<H>>> s;
