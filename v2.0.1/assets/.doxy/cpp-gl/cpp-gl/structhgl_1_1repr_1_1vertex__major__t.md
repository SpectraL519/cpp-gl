...
# Struct hgl::repr::vertex\_major\_t



[**ClassList**](annotated.md) **>** [**repr**](namespacehgl_1_1repr.md) **>** [**vertex\_major\_t**](structhgl_1_1repr_1_1vertex__major__t.md)



_Layout tag designating vertices as the primary structural dimension of the incidence representation._ 
...
| Type | Name |
| ---: | :--- |
| typedef [**vertex\_t**](structhgl_1_1vertex__t.md) | [**major\_element**](#typedef-major_element)  <br>_The major element type for this layout._  |
| typedef [**hyperedge\_t**](structhgl_1_1hyperedge__t.md) | [**minor\_element**](#typedef-minor_element)  <br>_The minor element type for this layout._  |
...
```cpp
using hgl::repr::vertex_major_t::major_element =  vertex_t;
```
...
```cpp
using hgl::repr::vertex_major_t::minor_element =  hyperedge_t;
```
...
static inline constexpr T repr::vertex_major_t::major (
    const T & vertex_el,
...
```cpp
template<std::regular T>
static inline constexpr T repr::vertex_major_t::minor (
    const T & vertex_el,
    const T & hyperedge_el
) noexcept
```
...
```cpp
template<std::regular T>
static inline constexpr  homogeneous_pair < T > repr::vertex_major_t::majmin (
    const T & vertex_el,
    const T & hyperedge_el
) noexcept
```
