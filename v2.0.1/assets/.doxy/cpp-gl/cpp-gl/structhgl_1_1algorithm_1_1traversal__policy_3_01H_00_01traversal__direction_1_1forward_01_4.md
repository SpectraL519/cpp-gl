...
# Struct hgl::algorithm::traversal\_policy&lt; H, traversal\_direction::forward &gt;

**template &lt;traits::c\_bf\_directed\_hypergraph H&gt;**



[**ClassList**](annotated.md) **>** [**algorithm**](namespacehgl_1_1algorithm.md) **>** [**traversal\_policy&lt; H, traversal\_direction::forward &gt;**](structhgl_1_1algorithm_1_1traversal__policy_3_01H_00_01traversal__direction_1_1forward_01_4.md)



_Traversal policy specialization for forward searches on BF-directed hypergraphs._ 
...
_Retrieves the hyperedges originating from the given vertex (forward star)._ 
```cpp
static inline auto algorithm::traversal_policy< H, traversal_direction::forward >::target_hyperedges (
    const  H & h,
...
_Retrieves the vertices targeted by the given hyperedge (head nodes)._ 
```cpp
static inline auto algorithm::traversal_policy< H, traversal_direction::forward >::target_vertices (
    const  H & h,
