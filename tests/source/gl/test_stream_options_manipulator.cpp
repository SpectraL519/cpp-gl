...
TEST_CASE_FIXTURE(
    ...
    ss1 >> gl::io::unset_options(bit_positions);
    ...
    CHECK(gl::io::is_option_set(ss1, bit_position_1));
    CHECK(gl::io::are_options_set(ss1, {bit_position_1}));
    CHECK_FALSE(gl::io::is_option_set(ss1, bit_position_2));
    CHECK_FALSE(gl::io::are_options_set(ss1, {bit_position_2}));
    CHECK_FALSE(gl::io::are_options_set(ss1, bit_positions));
    CHECK_FALSE(gl::io::are_options_set(ss1, options_bitmask));
}
...
TEST_CASE_FIXTURE(
    ...
    ss1 >> gl::io::set_options({BitPositionEnum::bit_position_1});
    CHECK(gl::io::is_option_set(ss1, BitPositionEnum::bit_position_1));
    CHECK(gl::io::are_options_set(ss1, {BitPositionEnum::bit_position_1}));
    CHECK_FALSE(gl::io::is_option_set(ss1, BitPositionEnum::bit_position_2));
    CHECK_FALSE(gl::io::are_options_set(ss1, {BitPositionEnum::bit_position_2}));
    CHECK_FALSE(gl::io::are_options_set(ss1, bit_positions));
    CHECK_FALSE(gl::io::are_options_set(ss1, options_bitmask));
}
