...
constexpr lib_t::size_type no_elements = 3ull;
...
constexpr lib_t::size_type last_element_idx = no_elements - one_element;
...
constexpr auto vertex_id_view = std::views::iota(first_element_idx, no_elements);
